    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Chat Furioso!</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Entre na conversa. Organize a estratégia. <br />Domine o jogo.
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                Acesse o
                                <a
                                    href="https://github.com/IllgnerJose/chat-furioso.git"
                                    target="_blank"
                ...
                <div class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-white bg-white lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none">
                    <div class="w-full h-full flex justify-center items-center">
                        <img :src="`/storage/img/furia.webp`" alt="Game Image">
                    </div>
                </div>
            </main>
        </div>
